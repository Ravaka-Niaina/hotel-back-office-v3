...
const LegalNotice = () => (
  ...
  <Container>
    <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
      <CustomizedTitle  text="Mentions légales" />
    </Stack>
    <CustomizedPaperOutside sx={{ ...lightBackgroundToTop, background: '#E3EDF7', p: 5, minHeight:'100vh' }}>
      <Stack spacing={2}>
        <Stack sx={{alignItems: "center"}}>
          <CustomizedTitle text="Mentions légales" size={44} level={0}/>
        ...
        <CustomizedTitle text="ARTICLE 1 - L'EDITEUR" level={0} size={24}/>
        ...
        <CustomizedTitle text="ARTICLE 2 - L'HEBERGEUR" level={0} size={24} />
        ...
        <CustomizedTitle text="ARTICLE 3 - ACCES AU SITE" level={0} size={24} />
        ...
        <CustomizedTitle text="ARTICLE 4 - COLLECTE DES DONNEES" level={0} size={24} />
