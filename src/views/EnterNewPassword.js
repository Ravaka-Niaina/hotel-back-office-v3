...
// sections
import EnterNewPasswordForm from '../components/enterNewPassword/EnterNewPasswordForm';
// ----------------------------------------------------------------------
...
export default function EnterCodeResetPassword() {
  return (
    <Page title="AIOLIA | Entrer Nouveau mot de passe" sx={{ backgroundColor: '#E8F0F8' }}>
      <RootStyle>
        <HeaderStyle>
          <div> </div>
        </HeaderStyle>
